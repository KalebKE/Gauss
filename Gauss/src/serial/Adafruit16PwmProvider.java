...
public class Adafruit16PwmProvider extends GpioProviderBase implements
		GpioProvider
{
	public static final String NAME = Adafruit16PwmProvider.class
			.getCanonicalName();
	...
	public void setPWMFreq(double freq) throws InterruptedException,
			IOException
	{
